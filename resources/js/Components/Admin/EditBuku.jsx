...
function EditBuku({ buku }) {
    ...
    const [selectedStatus, setSelectedStatus] = useState(buku.status);
    const [selectedCategory, setSelectedCategory] = useState(buku.kategori);
    ...
    const submit = (e) => {
        ...
        post(route('admin.update.product', {id: buku.id}), data);
                                        ...
                                        <div className="grid w-full grid-cols-1 lg:grid-cols-2 md:grid-cols-1 gap-7 mt-7 ">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    type="number"
                                                    name="halaman"
                                                    // defaultValue={buku.jumlah_halaman}
                                                    value={data.halaman}
                                                    onChange={(e) =>
                                                        handleChange(
                                                            "halaman",
