...
export default function DataBaru({ dataBukus, users, dataPraTransaksi }) {
                ...
                <div className="flex flex-wrap my-6 -mx-3">
                    ...
                    <div className="w-full max-w-full px-3 md:w-1/2 md:flex-none lg:w-1/3 lg:flex-none">
                        <div className="border-black/12.5 shadow-soft-2xl relative flex h-full min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
                            <div className="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-3">
                                <svg
                                ...
                                <h6 className="inline-block">Menunggu Transaksi</h6>
                            </div>
                            {dataPraTransaksi.map((dataTransaksi, index) => (
                                <div key={index} className=" px-4 pb-4">
                                    <div className="px-2 pt-1.4 lg:max-w-120 -top-1.5 w-auto">
                                        <h6 className="mb-0 text-sm font-semibold leading-normal text-slate-700">
                                            {dataTransaksi.buku.nama_buku}
                                        </h6>
